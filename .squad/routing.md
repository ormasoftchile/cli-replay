...
|-----------|----------|----------|
| Architecture & design | Clint | System design, scope decisions, trade-offs |
| Core replay engine | Gene | Instrumentation hooks, recording, replay logic |
| Command capture & serialization | Charles | Process exec, file I/O, playback fidelity |
| Code review | Clint | Review PRs, check quality, suggest improvements |
| Testing | Michael | Write tests, find edge cases, verify fixes |
| Scope & priorities | Clint | What to build next, trade-offs, decisions |
| API design & integration | Robert | Public API, gert integration, extensibility |
| Developer experience | Robert | Consumer-facing ergonomics, docs, examples |
